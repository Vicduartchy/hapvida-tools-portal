...
type ToolCategory = "Análise" | "Governança";
...
const tools: Tool[] = [
  ...
  {
    slug: "alocacao-horas-tipo-demanda",
    name: "Alocação de Horas por Tipo de Demanda",
    shortName: "Alocação de horas",
    description: "Consolide % de horas por tipo de demanda e diretoria, com totais por linha.",
    category: "Análise",
    icon: PieChart,
    accent: "navy",
    status: "Operacional",
    version: "1.0",
    tags: ["Horas", "Diretoria", "% Alocação"],
    updated: "Nova",
  },
  {
    slug: "conferencia-epicos-portfolio",
    name: "Conferência de Épicos — Portfólio x Azure DevOps",
    shortName: "Conferência de Épicos",
    description: "Cruza Portfólio, Features e Epics para achar Projects sem Epic confirmado no trimestre.",
    category: "Análise",
    icon: Layers,
    accent: "red",
    status: "Operacional",
  ...
  {
    slug: "apuracao-horas-recurso",
    name: "Apuração de Horas por Recurso",
    shortName: "Apuração de Horas",
    description: "Calcula % Melhoria/Projeto por colaborador a partir do export do BI e já gera no formato BASE_SET.26.",
    category: "Governança",
    icon: Percent,
    accent: "navy",
    status: "Operacional",
    version: "1.0",
    tags: ["Horas", "BI GovTI", "LECOM"],
    updated: "Nova",
  },
  {
