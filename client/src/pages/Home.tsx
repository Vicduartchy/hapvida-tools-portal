...
const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "Apuração de Horas por Recursos x Squad",
    shortName: "Apuração de Horas",
    description: "Cruze horas, melhorias, projetos e organograma por recurso e squad e exporte a base consolidada.",
    category: "Governança",
    icon: FileSpreadsheet,
    accent: "navy",
    status: "Operacional",
    version: "1.0",
    tags: ["Horas", "Recursos", "Squads"],
    updated: "Atualizada",
  },
  {
